...
```bash
nextflow run nf-core/clipseq -profile test,<docker/singularity/conda/institute>
```
...
```bash
nextflow run nf-core/clipseq -profile <docker/singularity/conda/institute> --reads '*_R{1,2}.fastq.gz' --genome GRCh37
```
...
The nf-core/clipseq pipeline comes with documentation about the pipeline, found in the `docs/` directory:
...
nf-core/clipseq was originally written by Luscombe Lab.

## Contributions and Support

If you would like to contribute to this pipeline, please see the [contributing guidelines](.github/CONTRIBUTING.md).

For further information or help, don't hesitate to get in touch on [Slack](https://nfcore.slack.com/channels/clipseq) (you can join with [this invite](https://nf-co.re/join/slack)).
