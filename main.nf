...
def helpMessage() {
    ...
    Other options:
      ...
      --save_index [bool]             If the STAR index is generated by the pipeline use this parameter to save it to your results folder. These can then be used for future pipeline runs, reducing processing times (Default: false)
...
/*---- Try different peakcaller logic ---*/
...
if (('icount' in callers) && !(params.genome in icount_compatible)) {
    icount_check = false
    log.warn "The provided genome '${params.genome}' is not compatible with the iCount peakcaller. Please see documentation"
}
